<x-content>
    ...
    <div class="bg-gray-50 p-2 rounded-lg">
        ...
        <div class="grid grid-cols-4 gap-4">
            @if ($estatus == false)
            <div
                class="px-2 pt-3 pb-1 col-span-4 md:col-span-2 border-t-4 border-red-500 bg-white bg-opacity-20  rounded-lg shadow-lg">
                @else
                <div
                    class="px-2 pt-3 pb-1 col-span-4 md:col-span-2 border-t-4 border-green-500  bg-white bg-opacity-20  rounded-lg shadow-lg">
                    @endif
                ...
                <div
                    class="h-auto px-2 pt-3 pb-1  col-span-4 md:col-span-2 border border-gray-200 rounded-lg shadow-lg">
                    <div>
                        <x-table.table>
                            <x-slot name="theader">
