<x-content>
    ...
    <div class="mb-3 flex items-center justify-between">
        ...
        <div class="flex items-center justify-between space-x-2">
            <div>
                <x-button class="space-x-2 rounded py-1.5 bg-indigo-700" type="button" wire:click="exportExcel">
                    <span>Exportar</span>
            ...
            <div>
                <x-form.select-sm name="" id="searchTipo" wire:model="searchTipo">
            ...
            <div>
                <x-form.select-sm name="" id="" wire:model="search_unidad">
            ...
            <div>
                <x-form.select-sm name="" id="searchUbicacion" wire:model="searchUbicacion">
            ...
            @endif
            <x-form.btn-primary class="py-1.5 rounded" wire:click="openModal()">
        ...
        <x-table.tr>
            ...
            <x-table.td>
                <div class="flex flex-col">
                    <h1 class="text-sm">{{ $espacio->nombre }}</h1>
            ...
            <x-table.td class="whitespace-nowrap">
                <div class="flex flex-col">
                    <span class="text-sm text-gray-700">{{ $espacio->unidad->nombre }} </span>
                    <span class="text-gray-500">{{ $espacio->ubicacion->nombre }}</span>
                </div>
            </x-table.td>
